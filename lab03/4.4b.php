...
*/
    function BCC($n=6, $colorHead="red", $color1="green", $color2="blue")
    {
    ?>
        ...
        echo  $tableHTML .= "<tr>
                <td colspan='3' bgcolor='$colorHead'>Bảng cửu chương $n</td>
            </tr>";

        for ($i = 1; $i <= 10; $i++) {
            if ($i % 2 != 0)
                echo $tableHTML .= "<tr  bgcolor=' $color1'>";
            else
...
*/
    ...
    $rerult = "";
    $funtionStore = ['BCC', 'BanCo'];
    foreach ($funtionStore as $value) {
        if (function_exists($value))
                $rerult .= $value($n,$coloHead,$color1,$color2);
